            ...
            <div class="modal-dialog" role="document">
                <div style="padding: 15px 10px!important;" class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- FORM COMPRA -->
                        <p style="text-align: center; margin-top: 10px;">Alterações enviadas!</p>
                        <div class="form-group col-lg-8">
                            <button id="btnConf" style="background-color:#f34747; color: white; margin-left: 60%; margin-top: 25px;"
                            type="button" class="btn" class="close" data-dismiss="modal" aria-label="Close"><a>Voltar</a></button>
                        </div>
                    </div>
        ...
        <nav style="font-family: 'Montserrat Alternates', sans-serif;" class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div style="margin-left: 10%;" class="collapse navbar-collapse" id="navbarText">
                <ul style="font-size: 18px!important" class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a style="color: black; text-shadow: .5px .5px 4px rgba(255,255,255,0.4);" class="nav-link"
                            href="/carrinho/usuarioServlet?acao=fazLogout">
            ...
            <div class="row">
                <div style="background:white;border: 1px solid rgba(0,0,0,0.2);box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.2);"
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6 col-md-12">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    value="${usuarioLogado.nomeCompleto}" name="nomeCompleto">
                            </div>
                            <div class="form-group col-lg-6 col-md-12">
                                <label for="exampleFormControlInput1">Apelido</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    value="${usuarioLogado.apelido}" name="apelido">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-6 col-md-12">
                                <label for="exampleFormControlInput1">E-mail</label>
                                <input type="email" class="form-control" id="Example" value="${usuarioLogado.email}"
                                    name="email">
                            </div>
                            <div class="form-group col-lg-6 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-8">
                            <button id="btnConf" style="background-color:#f34747;" type="submit" form="formAlteraDados"
                                class="btn btn-success" data-toggle="modal" data-target="#exampleModal">Enviar</button>
                        </div>
                    </div>
                </div>
                ...
                <div style="background:white;border: 1px solid rgba(0,0,0,0.2);box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.2);"
                    ...
                    <c:if test="${historicoPedidos != null}">
                        <c:forEach var="pedido" items="${historicoPedidos}">
                            <div style="font-size: 15px;margin-bottom: 15px;;border-bottom: 1px solid #f34747" class="history">
                                <i style="color:green;" class="fa fa-check" aria-hidden="true"></i>
                                <fmt:setLocale value="pt_BR" />
                                <a style="cursor: pointer; color:blue;">ID ${pedido.idPedido}</a> | ${pedido.cliente.nomeCompleto} | Valor compra: <fmt:formatNumber value="${pedido.valorTotal}" type="currency" />
                            </div>
                        </c:forEach>
                    </c:if>
                </div>
