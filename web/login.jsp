            ...
            <div class="esquerda col-lg-6">
                ...
                <form method="POST" action="/carrinho/usuarioServlet?acao=fazLogin">
                    <div style="margin: auto;" class="row col-lg-6">
                        ...
                        border: 1px solid white!important;" type="submit" class="btn btn-primary btnlogin">Entrar</button>
                    </div>
                </form>
            </div>
            ...
            <div class="direita col-lg-6">
                ...
                <form>
                    <div style="margin: auto; padding-bottom: 50px;" class="row col-lg-10">
                        ...
                        <button id="cadastrar" style="border: 1px solid white!important;" type="submit" form="formCadastro" class="btn btn-primary btnlogin">Cadastrar</button>
                    </div>
                </form>
            </div>
