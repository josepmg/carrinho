...
<body>
  ...
  <nav style="font-family: 'Montserrat Alternates', sans-serif;" class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div style="margin-left: 10%; justify-content: center;" class="collapse navbar-collapse" id="navbarText">
      <ul style="font-size: 18px" class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a style="color: black;" class="nav-link" href="login.html">
  ...
  <div style="padding:0!important;margin:0x!important " class="container-fluid">
    ...
    <div style="margin-top: 4%;" class="row justify-content-md-center">
      ...
      <div
        style="border: 1px solid black;width:300px; height: 300px!important; margin-left: 5px; background-color: white;"
        class="col-sm-6 col-md-2 col-lg-2 box">
        Produto 1 - x quantd.
        <button style="bottom: 5px; right: 5px; float: right; position: absolute;" type="button" class="btn btn-danger">
      ...
      <div
        style="border: 1px solid black;width:300px; height: 300px!important; margin-left: 5px; background-color: white;"
        class="col-xs-10 col-sm-6 col-sm-6 col-md-2 col-lg-2 box">
        Produto 2 - x quantd.
        <button style="bottom: 5px; right: 5px; float: right; position: absolute;" type="button" class="btn btn-danger">
          <i class="fas fa-minus"></i>
    ...
    <div style="margin-top: 1%;" class="row justify-content-md-center">
      ...
      <div
        style="border: 1px solid black;width:300px; height: 300px!important;margin-left: 5px; background-color: white;"
        class="col-xs-10 col-sm-6col-sm-6 col-md-2 col-lg-2 box">
        Produto 7 - x quantd.
        <button style="bottom: 5px; right: 5px; float: right; position: absolute;" type="button" class="btn btn-danger">
          <i class="fas fa-minus"></i>
